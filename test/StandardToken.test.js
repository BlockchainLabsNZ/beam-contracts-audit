...
const BeamToken = artifacts.require('BeamToken.sol');
...
contract('StandardToken', function ([_, owner, recipient, anotherAccount]) {
  ...
  beforeEach(async function () {
      this.token = await BeamToken.new();
      this.crowdsale = await BeamCrowdsale.new(owner, this.token.address);
      await this.token.setManager(owner);
